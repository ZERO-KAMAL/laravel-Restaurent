    ...
    <div id="top">
        <table>
            ...
            @foreach ($data2 as $data2)
                <tr style="position: relative; top:-38px; right:-345px">
                    <td><a href="{{ url('/remove', $data2->id) }}" class="btn btn-primary">Remove</a></td>
                </tr>
            @endforeach
        ...
        <div class="ordernow" id="appear">
            ...
            <div>
                ...
                <button class="btn btn-success " id="close" type="submit" value='no order'> Close</button>
            </div>
